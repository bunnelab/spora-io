...
.. code-block:: text
   ...
   <dataset_name>/imc/1_0mpp/standardization/quantile_clipping/uq_0.99/
...
.. code-block:: python
   ...
   ds = MultiplexImagingDataset(
       ...
       resolution=1.0,
       tile_size=None,
       standardization="quantile_clipping_sqrt/uq_0.99",
   )
...
- ``quantile_clipping/uq_0.99`` and ``quantile_clipping_log1p/uq_0.99`` exist
